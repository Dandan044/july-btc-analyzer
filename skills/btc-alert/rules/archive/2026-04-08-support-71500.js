...
module.exports = {
  ...
  async collect() {
    try {
      ...
      return {
        ...
        alertType: '支撑位跌破',
        significance: '$71,500支撑位跌破，预示回调开始，等待$69,500-$70,000支撑测试',
        analysisContext: {
          reportId: 'btc-report-2026-04-08-0900',
          direction: 'down',
          recommendation: '跌破后等待$69,500-$70,000支撑测试'
        }
      };
    } catch (error) {
  ...
  async trigger(data) {
    ...
    const jobName = `alert-support-71500-${Date.now()}`;
