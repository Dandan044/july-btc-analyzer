...
module.exports = {
  ...
  async collect() {
    try {
      ...
      return {
        ...
        alertType: '支撑位跌破',
        significance: '跌破$73,900关键支撑，可能加速下跌至$72,000',
        recommendation: '若跌破确认，可考虑做空，止损$74,500，止盈$72,000/$70,500'
      };
    } catch (error) {
  ...
  async trigger(data) {
    ...
    const jobName = `alert-support-73900-${Date.now()}`;
