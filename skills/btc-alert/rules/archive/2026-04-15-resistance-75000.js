/**
 * 阻力位突破警报
 * 监控 BTC 价格突破关键阻力位 $75,000
 * 突破后确认反弹延续，可能继续上涨至$76,000/$76,500
 *
 * ========== 当前状态 ==========
 * 周期已归档 | 观望等待新信号
 * 监控: 价格突破 $75,000
  ...
  async collect() {
    try {
      ...
      return {
        ...
        alertType: '阻力位突破',
        significance: '突破$75,000关键阻力，若量能放大确认，可能继续上涨至$76,000/$76,500',
        recommendation: '若突破确认，可考虑做多。止损$73,800，止盈$76,000/$76,500'
      };
    } catch (error) {
