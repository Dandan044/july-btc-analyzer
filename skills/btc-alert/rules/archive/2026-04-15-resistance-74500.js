/**
 * 阻力位突破警报
 * 监控 BTC 价格突破关键阻力位 $74,500
 * 突破后确认反弹，可能继续上涨至$75,500/$76,000
 *
 * ========== 当前状态 ==========
 * 无持仓 | 观望等待反弹确认
 * 监控: 价格突破 $74,500
...
module.exports = {
  ...
  async collect() {
    try {
      ...
      return {
        ...
        alertType: '阻力位突破',
        significance: '突破$74,500关键阻力，确认反弹，可能继续上涨至$75,500/$76,000',
        recommendation: '若突破确认，可考虑做多，止损$73,500，止盈$75,500/$76,500'
      };
    } catch (error) {
  ...
  async trigger(data) {
    ...
    const jobName = `alert-resistance-74500-${Date.now()}`;
