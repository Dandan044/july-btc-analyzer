/**
 * 阻力位突破警报
 * 监控 BTC 价格突破关键阻力位 $75,500
 * 突破后可能继续上涨至$76,000/$77,000
 *
 * ========== 当前状态 ==========
 * 无持仓 | 观望等待方向确认
 * 监控: 价格突破 $75,500
...
module.exports = {
  ...
  async collect() {
    try {
      ...
      return {
        ...
        alertType: '阻力位突破',
        significance: '突破$75,500关键阻力，可能继续上涨至$76,000/$77,000',
        recommendation: '若突破确认，可考虑做多，止损$74,000，止盈$76,500/$78,000'
      };
    } catch (error) {
  ...
  async trigger(data) {
    ...
    const jobName = `alert-resistance-75500-${Date.now()}`;
