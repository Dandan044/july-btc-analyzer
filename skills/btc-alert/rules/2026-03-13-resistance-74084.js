/**
 * 压力位突破警报 - $74,084 (3月4日高点)
 * 监控 BTC 价格突破 $74,084 关键阻力位
 * 这是30日内的关键阻力位，突破后将打开上行空间
 */

const api = require('../../btc-market-lite/scripts/api');
const { spawn } = require('child_process');

const CREATED_DATE = '2026-03-13';
const TARGET_PRICE = 74084;
const COOLDOWN_MS = 60 * 60 * 1000; // 1小时冷却

module.exports = {
  name: '压力位突破警报-74084-3月4日高点',
  interval: 5 * 60 * 1000,
  lastTriggered: 0,
