/**
 * 支撑位跌破警报 - $72,000 (EMA7强支撑)
 * 监控 BTC 价格跌破 $72,000
 * $76,000止盈后，若跌破$72,000需警惕趋势转弱
 * EMA7当前约$72,430，跌破EMA7意味着短期趋势可能逆转
 */

const api = require('../../btc-market-lite/scripts/api');
const { spawn } = require('child_process');

const CREATED_DATE = '2026-03-17';
const TARGET_PRICE = 72000;
const COOLDOWN_MS = 60 * 60 * 1000; // 1小时冷却

module.exports = {
  name: '支撑位跌破警报-72000-EMA7强支撑',
  interval: 5 * 60 * 1000,
  lastTriggered: 0,
