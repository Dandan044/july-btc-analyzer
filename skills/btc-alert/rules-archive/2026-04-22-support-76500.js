/**
 * 支撑位跌破警报 - $76,500
 * 触发条件：BTC 价格跌破 $76,500（4H收盘）
 * 触发后：执行即时分析，评估是否做空
 * 
 * 依据：$76,500 为04-17/04-21/04-22 四次验证的强压力位，
 *       今日10:00终于突破后，已从压力转为支撑。
 *       跌破 $76,500 说明突破失败，恢复震荡或转空，
 *       下一个支撑为 $75,568.2（4H 23.6%斐波那契位）。
 */
  ...
  async collect() {
    try {
      ...
      return {
        ...
        significance: '$76,500 为四次验证的强支撑位（支撑转换），跌破说明突破失败，恢复震荡或转空，下看 $75,568.2（4H 23.6%斐波那契位）。'
      };
    } catch (error) {
